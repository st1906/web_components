...
const InflationConverter = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { class: "tooltip" }, this.moneyValue, " $", index.h("span", { class: "tooltiptext" }, this.inflatedValue))));
    }
};
...
const SocialMediaWidget = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("div", { class: "facebook" }, index.h("a", { href: this.facebookLink }, "Go to Facebook")), index.h("div", { class: "twitter" }, index.h("a", { href: this.twitterLink }, "Go to Twitter")), index.h("div", { class: "youtube" }, index.h("a", { href: this.youtubeLink }, "Go to YouTube"))));
    }
};
...
exports.inflation_converter = InflationConverter;
